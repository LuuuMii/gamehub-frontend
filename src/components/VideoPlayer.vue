<template>
  <div class="video-wrapper">
    ...
    <!-- 弹幕控制放在播放器下方 -->
    <div class="danmuku-control">
      <div class="watching-text">
        <span>1 </span>人正在看,已装填<span> 0 </span>条弹幕
      </div>
       <!-- 开启弹幕icon -->
      <div class="danmu-icon" v-show="isShowDanmuFlag" @click="handlerOpenOrCloseDanmu">
        <svg
      ...
      <div class="danmu-box">
        <div class="danmu-wrapper">
          <div class="left-wrapper">
            ...
            <div><input class="inputDanmu" placeholder="12312" type="text" name="" id="" /></div>
          </div>
          <div class="danmu-etiquette">
            <span>弹幕礼仪</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              xml:space="preserve"
...
export default {
  ...
  methods: {
    ...
    // 开启或者关闭弹幕
    handlerOpenOrCloseDanmu(){
      this.isShowDanmuFlag = !this.isShowDanmuFlag;
    }
  },
  beforeDestroy() {
    if (this.art) {
...
.danmu-etiquette span {
  font-size: 14px;
  color: #9499a0;
  line-height: 20px;
}
.danmu-etiquette:hover span {
  color: #00aeec;
}
.danmu-etiquette:hover svg {
  fill: #00aeec;
}
.danmu-etiquette svg {
  height: 20px;
